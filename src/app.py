...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice shooting, dribbling, and teamwork on the court",
    ...
    "Drama Club": {
        "description": "Work on acting, stagecraft, and school theater productions",
    ...
    "Science Olympiad": {
        ...
        "max_participants": 15,
        "participants": ["elia@mergington.edu", "nora@mergington.edu"]
    },
    "Debate Team": {
